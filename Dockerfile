# Copy over docker file from https://hub.docker.com/r/splashblot/docker-postgis/dockerfile and add in postgres 11 image 
FROM postgres:11
...
RUN ln -s usr/local/bin/docker-entrypoint-cron.sh /
